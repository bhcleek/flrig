...
extern Fl_Double_Window *log_viewer; 
#include <FL/Fl_Double_Window.H>
#include "status.h"
#include "cwio.h"
...
extern Fl_Output *txt_log_file;
extern Fl_Group *grp_qso_data;
extern Fl_Input2 *qso_op_freq;
extern Fl_Button *btn_clear_qso;
extern Fl_Button *btn_save_qso;
extern Fl_Button *btn_edit_entry;
extern Fl_Button *btn_delete_entry;
...
extern Fl_Button *btn_log_datetime;
...
extern Fl_Browser *brwsr_log_entries;
Fl_Double_Window* new_logbook_dialog();
extern unsigned char menu__i18n_done;
extern Fl_Menu_Item menu_[];
#define log_menu_open (menu_+1)
#define log_menu_new (menu_+2)
#define log_menu_save (menu_+3)
#define log_menu_save_as (menu_+4)
#define log_menu_export_adif (menu_+5)
#define log_menu_import_adif (menu_+6)
#define log_menu_dupcheck (menu_+9)
#define log_menu_leading_zeros (menu_+10)
#define log_menu_cut_numbers (menu_+11)
#endif
